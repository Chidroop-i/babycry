...
public class waveGenerator extends View {
    ...
    private Runnable animateTicker = new Runnable() {
        public void run() {
            requestUpdateFrame();
            ViewCompat.postOnAnimation(waveGenerator.this, this);
        }
    };
    ...
    public waveGenerator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public waveGenerator(Context context, AttributeSet attrs, int defStyleAttr) {
